...
public function checkout(Request $request){
   ...
   /*  $commande = Commande::find($request->commande_id); */
    ...
    $commande->etat = "paye";
    $commande->payment_method=$request->paymentMethod;
    $commande->delivery_phone=$request->phoneNumber;
    $commande->delivery_address=$request->deliveryAddress;
    $commande->emaildel=$request->email;
 /*    dd($qtesc); */
