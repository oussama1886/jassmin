...
<body>
                                    ...
                                    @foreach ($categories as $index => $c)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a data-bs-toggle="modal" data-bs-target="#editCategory" data-id="{{ $c->id }}" class="btn btn-success">Modifier</a>
    ...
    <!-- modal ajouter -->
    <div class="modal fade" id="exampleModal" data-id="{{ $c->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" _mstvisible="0"
    ...
    <div class="modal fade" id="editCategory{{ $c->id }}" data-id="{{ $c->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" _mstvisible="0"
        ...
        <div class="modal-dialog" _mstvisible="1">
            <div class="modal-content" _mstvisible="2">
                <div class="modal-header" _mstvisible="3">
                    <h5 class="modal-title" id="exampleModalLabel" _msttexthash="156741" _msthash="142"
                        _mstvisible="4">Modifier categorie : <span class="text-primary">{{ $c->name }}</span></h5><button class="btn p-1" type="button"
                        data-bs-dismiss="modal" aria-label="Fermer" _mstaria-label="59709" _msthash="143"
                        _mstvisible="4"><svg class="svg-inline--fa fa-times fa-w-11 fs--1" aria-hidden="true"
                            focusable="false" data-prefix="fas" data-icon="times" role="img"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 352 512" data-fa-i2svg=""
                ...
                <form action="/admin/categories/{{ $c->id }}/update" method="post">
                    @csrf
                    <div class="modal-body" _mstvisible="3">
