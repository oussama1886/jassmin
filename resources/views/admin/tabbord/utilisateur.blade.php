...
<main class="main" id="top">
    ...
    <div>
        <h2>Nombre des utilisateurs Actif: {{ $data['paye'] }}</h2>
        <h2>Nombre des utilisateurs Bloque  : {{ $data['en_cours'] }}</h2>
    ...
    <script>
        ...
        const labels = ['utilisateurs Bloque', 'utilisateurs Actif'];
        const datasets = [{
            label: 'Sales',
            data: [{{ $data['en_cours'] }}, {{ $data['paye'] }}], // Sample data
            backgroundColor: [
                'rgb(255, 99, 132)',
                'rgb(54, 162, 235)',
                'rgb(255, 205, 86)',
